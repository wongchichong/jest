...
const createToBeCalledMatcher = (
  ...
  function (this: MatcherContext, received: any, expected: unknown): SyncExpectationResult {
...
const createToBeCalledTimesMatcher = (
  ...
  function (this: MatcherContext, received: any, expected: number): SyncExpectationResult {
    ...
    const receivedIsSpy = isSpy(received);
    const receivedName = receivedIsSpy ? 'spy' : received.getMockName();
    const count: number = receivedIsSpy
      ? received.calls.count()
      : received.mock.calls.length;
...
const createToBeCalledWithMatcher = (
  ...
  function (this: MatcherContext, received: any, ...expected: []): SyncExpectationResult {
    const expectedArgument = '...expected';
    const options: MatcherHintOptions = {
      isNot: this.isNot,
      promise: this.promise,
...
const createToReturnWithMatcher = (
  ...
  function (this: MatcherContext, received: any, expected: any): SyncExpectationResult {
    const expectedArgument = 'expected';
    const options: MatcherHintOptions = {
      isNot: this.isNot,
      promise: this.promise,
...
const createNthCalledWithMatcher = (
  ...
  function (this: MatcherContext, received: any, nth: number, ...expected: []): SyncExpectationResult {
...
const createNthReturnedWithMatcher = (
  ...
  function (this: MatcherContext, received: MockInstance, nth: number, expected: unknown): SyncExpectationResult {
    const expectedArgument = 'n';
    const options: MatcherHintOptions = {
      expectedColor: (arg: string) => arg,
      isNot: this.isNot,
...
const isMock = (received: MockInstance): received is MockInstance =>
  received != null && received._isMockFunction === true;

const isSpy = (received: any/* MockInstance['mock'] */) =>
  received != null &&
  received.calls != null &&
